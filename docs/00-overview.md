...
This folder is the **public structure documentation** for the ThinkingSOC Lite Splunk hackathon repository. It explains what the system is, how Splunk and the external application connect, how analysis runs, and how the codebase is organized.
...
flowchart TD
  ...
  LITE["25 ThinkingSOC Lite Runbooks"]
...
| **25** | [25-verified-runbook-lite.md](./25-verified-runbook-lite.md) | ThinkingSOC Lite — technical contracts, API, verification, persistence, UI, and evidence pack |
| **26** | [26-hackathon-lite-product-guide.md](./26-hackathon-lite-product-guide.md) | Hackathon feature delta, GPT-5.6 role, trust boundary, demo, and acceptance claims |
| **27** | [27-lite-us-soc-economic-impact.md](./27-lite-us-soc-economic-impact.md) | U.S. SOC capacity and ROI model with official labor sources and reproducible formulas |
